...
const DEFAULT_PC_NAVIGATION_GROUPS: readonly NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: 'reference-data-dictionaries',
        label: '字典管理',
      ...
      {
        id: 'reference-data-parameters',
        label: '参数管理',
        routeName: 'reference-data-parameters',
        icon: Tickets,
        permission: PERMISSIONS.referenceDataParameterView,
      },
      {
        id: 'reference-data-dynamic-properties',
        label: '动态属性',
        routeName: 'reference-data-dynamic-properties',
        icon: Tickets,
        permission: PERMISSIONS.referenceDataDynamicPropertyView,
      },
      {
        id: 'reference-data-units-of-measure',
        label: '计量单位',
        routeName: 'reference-data-units-of-measure',
        icon: Tickets,
      ...
      },
      {
        ...
        label: '编码规则',
        routeName: 'reference-data-coding-rules',
        icon: Tickets,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: '文件管理',
        sectionId: 'service-operations',
        routeName: 'systemdata-files',
        icon: Tickets,
        permission: PERMISSIONS.systemDataFileRead,
      },
      {
        id: 'systemdata-notifications',
        label: '通知与公告',
        sectionId: 'service-operations',
        routeName: 'systemdata-notifications',
        icon: Tickets,
        permission: PERMISSIONS.systemDataNotificationAnnouncementRead,
      },
      {
        id: 'systemdata-audits',
        label: '审计查询',
        sectionId: 'service-operations',
        routeName: 'systemdata-audits',
        icon: Tickets,
