...
export const ROUTE_NAMES = {
  ...
  collaborationConversation: 'collaboration-conversation',
  collaborationCompliance: 'collaboration-compliance',
  collaborationComplianceSearch: 'collaboration-compliance-search',
  collaborationLegalHolds: 'collaboration-legal-holds',
  collaborationExports: 'collaboration-exports',
  collaborationRetention: 'collaboration-retention',
  ...
  referenceDataUnitsOfMeasure: 'reference-data-units-of-measure',
  referenceDataMetadata: 'reference-data-metadata',
  referenceDataCodingRules: 'reference-data-coding-rules',
  referenceDataStateMachines: 'reference-data-state-machines',
  workspaceTabsSandbox: 'workspace-tabs-sandbox',
  uiBaseline: 'ui-baseline',
  pdaHome: 'pda-home',
  pdaFiles: 'pda-files',
  pdaNotifications: 'pda-notifications',
  pdaCollaborationChat: 'pda-collaboration-chat',
  pdaCollaborationConversation: 'pda-collaboration-conversation',
  mobileHome: 'mobile-home',
  mobileMy: 'mobile-my',
  mobileFiles: 'mobile-files',
  mobileNotifications: 'mobile-notifications',
  mobileCollaborationChat: 'mobile-collaboration-chat',
  mobileCollaborationConversation: 'mobile-collaboration-conversation',
  notFound: 'not-found',
} as const
