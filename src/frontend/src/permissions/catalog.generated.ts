/**
 * Generated permission NId directory.
 * Keep this file data-only; the contract test compares it with the frontend map
 * and the backend catalog test owns the authoritative ordering at the service edge.
 */
export const GENERATED_PERMISSION_NIDS = [
  'identity.user.view',
