...
public static class IdentitySchemaMigrations
{
    ...
    [
        ...
        (PermissionCatalog.UserDelete, "安全删除用户", PermissionType.Action),
        (PermissionCatalog.UserRestore, "恢复用户墓碑", PermissionType.Action),
        ...
        (PermissionCatalog.UserGroupDelete, "安全删除用户组", PermissionType.Action),
        (PermissionCatalog.UserGroupRestore, "恢复用户组墓碑", PermissionType.Action),
