...
[ApiController]
[Route("internal/initialization/identity")]
public sealed class InternalInitializationController : ControllerBase
{
    private readonly IdentityServiceInitializer _initializer;
    private readonly IConfiguration _configuration;
    private readonly IHostEnvironment _environment;

    public InternalInitializationController(
        IdentityServiceInitializer initializer,
    ...
    private ServiceInitializationContext Context(InternalInitializationRequest request) =>
        InternalInitializationAuthentication.BuildContext(request, "identity", "identity", _environment.EnvironmentName);
