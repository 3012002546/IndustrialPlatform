...
/// <summary>
/// ReferenceData 服务认证扩展(TASK-SD-006):JwtBearer 自校验(iss/aud/lifetime/签名),
...
/// </summary>
public static class ReferenceDataAuthenticationServiceCollectionExtensions
{
    /// <summary>
    ...
    public static IServiceCollection AddReferenceDataAuthentication(
        ...
        IConfiguration configuration)
    {
        ...
        services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
            .AddJwtBearer(options =>
            {
                ...
                // 独立 ReferenceData 不持有 Identity 私钥。没有显式公钥时，按标准 JWKS
                    ...
                    && !string.IsNullOrWhiteSpace(jwt["JwksUrl"]))
                {
                    options.ConfigurationManager = new ConfigurationManager<OpenIdConnectConfiguration>(
                        jwt["JwksUrl"]!,
                        new ReferenceDataJwksConfigurationRetriever(),
...
/// </summary>
internal sealed class ReferenceDataJwksConfigurationRetriever : IConfigurationRetriever<OpenIdConnectConfiguration>
{
