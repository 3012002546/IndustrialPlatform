...
public sealed class ResourceNavigationService : IResourceNavigationService
{
    ...
    private static readonly DefaultNavigationDeclaration[] DefaultNavigation = [
        ...
        new("navigation.group.reference-data", NavigationNodeKind.Group, "参考数据", null, null, null, 1),
        ...
        new("navigation.link.reference-data-dynamic-properties", NavigationNodeKind.Link, "动态属性", "navigation.group.reference-data", "reference-data-dynamic-properties", "referencedata.dynamic-property.view", 2),
        new("navigation.link.reference-data-units-of-measure", NavigationNodeKind.Link, "计量单位", "navigation.group.reference-data", "reference-data-units-of-measure", "referencedata.unit-of-measure.view", 3),
        new("navigation.link.reference-data-metadata", NavigationNodeKind.Link, "元数据 Schema", "navigation.group.reference-data", "reference-data-metadata", "referencedata.metadata.view", 4),
