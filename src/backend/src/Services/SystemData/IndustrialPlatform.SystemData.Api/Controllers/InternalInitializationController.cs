...
[ApiController]
[Route("internal/initialization/systemdata")]
public sealed class InternalInitializationController : ControllerBase
{
    ...
    public InternalInitializationController(
        SystemDataServiceInitializer initializer,
    ...
    private ServiceInitializationContext Context(InternalInitializationRequest request) =>
        InternalInitializationAuthentication.BuildContext(request, "systemdata", "systemdata", _environment.EnvironmentName);
