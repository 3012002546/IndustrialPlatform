...
/// <summary>
/// 管理端点全栈测试替身(TASK-SD-006):组织/岗位/任职存储端口、用户目录端口、
/// advisory lock 与本地审计命令的进程内实现。与 FakeDatabaseOrchestrationStore 同模式:
/// Add 遇唯一冲突、Update 遇双版本不匹配抛 <see cref="ConcurrencyException"/>,
