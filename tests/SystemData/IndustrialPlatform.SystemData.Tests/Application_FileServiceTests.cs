...
public sealed class FileServiceTests
{
    ...
    private sealed class FileStoreStub : IFileStore
    {
        ...
        public Task<FileObjectRecord?> GetFileAsync(string tenantNId, string fileNId, CancellationToken cancellationToken) => Task.FromResult<FileObjectRecord?>(null);
        ...
        public Task<FileObjectRecord?> CompleteSessionAsync(FileUploadSessionRecord completedSession, FileObjectRecord file, long expectedOffset, int expectedEpoch, CancellationToken cancellationToken) => Task.FromResult<FileObjectRecord?>(file);
        ...
        public Task<FileReferenceRecord?> GetReferenceAsync(string tenantNId, string referenceNId, CancellationToken cancellationToken) => Task.FromResult<FileReferenceRecord?>(null);
        public Task<FileReferenceRecord?> GetReferenceForFileAsync(string tenantNId, string fileNId, string ownerUserNId, CancellationToken cancellationToken) => Task.FromResult<FileReferenceRecord?>(null);
        public Task<bool> HasActiveReferencesAsync(string tenantNId, string fileNId, CancellationToken cancellationToken) => Task.FromResult(false);
        ...
        public Task UpdateFileAsync(FileObjectRecord file, CancellationToken cancellationToken) => Task.CompletedTask;
    }
}
