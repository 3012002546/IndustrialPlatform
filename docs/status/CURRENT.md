...
- PF-05/06 实施 08/09 V1.1：平台原生优先、可信宿主嵌入、三端 Web、可靠性/多人授权/真实断流整改；未派遣或实施。
- PF-05 → PF-06 → **PF-06A 终端运行时与客户端打包**（蓝图 34、实施 09A）→ PF-07～PF-10A → **PF-10B 标签管理平台**（蓝图 35、实施 13B）→ PF-11 IoTCollector → MES。原编号保持，新阶段待细化。
